...
agentic-software-steward/
  ...
  skills/
    ...
    graph-engineering/
      ...
      references/
        task-graphs.md
        skill-directed-agent-assembly.md
        knowledge-graphs.md
    workflow-automation-architect/
      SKILL.md
      references/
        friction-observer.md
        method-selection.md
        workflow-contract.md
        ob1-openbrain-handoff.md
    exponential-strategy/
      SKILL.md
      references/
        exo-3-model.md
        opportunity-routing.md
        exponential-opportunity-contract.md
...
Keep specialist skills modular. `100-year-copywriting-engine` is the bundled direct-response and campaign specialist; `ai-brand-voice` may be bundled or supplied by the user; Impeccable remains an optional companion. The orchestrator should load each only when the surface warrants it.
